...
From a boolean logic perspective, top-level match objects are `OR`-ed together and individual match rules within an object are `OR`-ed as well. Combined with `!` negation, you can write complex matching rules.
